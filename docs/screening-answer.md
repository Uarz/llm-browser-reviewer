...
**LLM API used:** OpenAI Responses API through the official `openai` Node.js SDK. The project reads `OPENAI_API_KEY` from the environment and calls `client.responses.create()` to generate the report.
